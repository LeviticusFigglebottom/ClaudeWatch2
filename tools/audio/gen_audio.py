...
_HERO_MAP = {
    ...
    "cairn": dict(boulder_impact="impact_mortar", landslide_cast="ult_cast", landslide_fire="rock_lob", landslide_end="beam_end",
    ...
    "coil": dict(blackout_cast="ult_cast", blackout_fire="lightning_arc", blackout_impact="impact_bolt", blackout_end="beam_end",
    ...
    "ferry": dict(crossing_cast="ult_cast", crossing_fire="teleport_out", crossing_loop="ult_loop", crossing_end="teleport_in",
    ...
    "kiln": dict(blast_impact="explosion_small", meltdown_cast="ult_cast", meltdown_loop="meltdown", meltdown_end="beam_end",
    ...
    "sable": dict(blades_impact="melee_hit", lunge_cast="dash", lunge_impact="melee_hit", lunge_end="short_tail",
    ...
    "suture": dict(adrenaline_apply="buff_chime", adrenaline_fire="buff_chime", tether_fire="heal_bolt", triage_cast="ult_cast",
                   triage_fire="heal_pulse"),
    "tallow": dict(bolt_impact="impact_candle", last_light_apply="cleanse_chime", snuff_apply="burn_apply", snuff_fire="flame_bolt",
    ...
    "vesper": dict(focus_on="focus_on", focus_off="focus_off", lantern_throw="throw_whoosh", ult="ult_cast", ult_loop="ult_loop",
