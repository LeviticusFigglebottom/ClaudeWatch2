...
static func build() -> HeroData:
	...
	var prim := A.weapon(&"coil_chain", "Arc Gauntlet", "Hitscan lightning: 30 damage, 4 shots per second, 25 m range, no falloff. Each hit chains to up to two more enemies within 6 m of the target for 21 and 15 damage. 12 cells, 1.4 s recharge.", 4.0, 12, 1.4)
